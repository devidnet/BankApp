...
import org.example.controller.providers.BalanceByAccountIdProvider;
...
public class ControllerManager {
    ...
    public BankAccountController getAccountController() {
        return new BankAccountController(new WithdrawOperator(new DataSaverInMemory()),
            ...
            new TransactionsByAccountIdProvider(new DataSaverInMemory()),
            new BalanceByAccountIdProvider(new DataSaverInMemory()));
    }
